    ...
    <div className="flex h-screen bg-gray-100 font-roboto overflow-hidden">
      ...
      <style>{`
        ...
        @keyframes blob1 {
          ...
          50% { transform: translate(4px,-4px) scale(1.2); opacity: 0.8; }
        }
        @keyframes blob2 {
          0%, 100% { transform: translate(0,0) scale(1); opacity: 0.6; }
          50% { transform: translate(-4px,4px) scale(1.2); opacity: 0.9; }
        }
      `}</style>
        ...
        <header className="bg-white h-16 px-6 flex items-center justify-between border-b border-gray-200 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold text-gray-800">
              {navItems.find(n => n.path === location.pathname)?.label || 'Student Portal'}
            </h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '8px',
                background: 'linear-gradient(135deg, #0a1a14, #0d2a1f)',
              ...
              onMouseEnter={e => {
                e.currentTarget.style.boxShadow = '0 0 28px rgba(0,255,180,0.3)';
                e.currentTarget.style.borderColor = 'rgba(0,255,180,0.5)';
              }}
              onMouseLeave={e => {
                e.currentTarget.style.boxShadow = '0 0 16px rgba(0,255,180,0.12)';
                e.currentTarget.style.borderColor = 'rgba(0,255,180,0.25)';
              }}
            >
              {/* Mini Siri ball */}
              <div style={{
                ...
                height: '28px',
                borderRadius: '50%',
                background: 'radial-gradient(circle at 30% 30%, #00FFD1, #00B894 25%, #1B6B5A 60%, #00B894 90%)',
